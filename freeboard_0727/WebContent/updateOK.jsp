...
//	update.jsp에서 넘어오는 수정할 글 번호, 돌아갈 페이지 번호, 수정하기 위해 입력한 비밀번호, 수정할 이름과
//	내용을 받는다.
...
<%
//	수정할 글의 비밀번호와 수정하기 위해 입력한 비밀번호를 비교하기 위해 테이블에서 수정할 글을 얻어온다.
	FreeboardVO original = FreeboardService.getInstance().selectByIdx(vo.getIdx());

//	수정할 글의 비밀번호와 수정하기 위해 입력한 비밀번호를 비교해 같으면 글을 수정한다.
	out.println("<script>");
