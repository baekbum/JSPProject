...
public class FreeboardList {
	...
	private ArrayList<FreeboardVO> list = new ArrayList<>();	// 한 페이지 분량의 글
	private int pageSize;			// 화면에 표시할 글의 개수
	private int totalCount;			// 전체 글의 개수
	private int currentPage;		// 화면에 표시할 페이지 번호
	private int totalPage;			// 전체 페이지 개수
	private int startNo;			// 화면에 표시할 글의 시작 일련번호
	private int endNo;				// 화면에 표시할 글의 마지막 일련번호	
	private int startPage;			// 페이지 이동 하이퍼링크(버튼)의 시작 페이지 번호
	private int endPage;			// 페이지 이동 하이퍼링크(버튼)의 마지막 페이지 번호
